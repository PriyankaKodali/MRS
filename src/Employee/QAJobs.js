...
class QAJobs extends Component{
    
    constructor(props){
        super(props);
        this.state={
            QAJobs:[], IsDataAvailable: true, dataTotalSize:1, currentPage:1, sizePerPage:10
        }
    }
    ...
    GetQAJobs(){
        // $.ajax({
        //     url: MRSUrl + "/api/Jobs/GetQAJobs?empNum=" + sessionStorage.getItem("userName"),
        //     type: "get",
        //     success: (data) => { this.setState({ QAJobs: data["QAJobs"] }) }
        // });
        ...
        return(
            ...
            <div className="row">
                <div className="col-md-12">
                    <strong className="empJobsHeader"> QA Jobs  </strong>
             ...
             <div key={this.state.QAJobs}>
                   <BootstrapTable striped hover remote={true} data={this.state.QAJobs} >
                        ...
                        <TableHeaderColumn dataField="AQA" width="20" dataFormat={this.AQADataFormatter.bind(this)}> AQA </TableHeaderColumn>
